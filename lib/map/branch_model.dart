...
//
//     final maxWayBranch = maxWayBranchFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

MaxWayBranch maxWayBranchFromJson(String str) => MaxWayBranch.fromJson(json.decode(str));

String maxWayBranchToJson(MaxWayBranch data) => json.encode(data.toJson());
...
class MaxWayBranch {
  ...
  factory MaxWayBranch.fromJson(Map<String, dynamic> json) => MaxWayBranch(
...
enum WorkHourStart { THE_1000, THE_0900 }
